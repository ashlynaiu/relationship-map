...
class crudButtons extends Component {
  render() {
    return (
        <div>
            <button class="slds-button slds-button_stateful slds-button_neutral slds-not-selected circle-button-remove slds-is-absolute" aria-live="assertive">
            ...
            <button class="slds-button slds-button_stateful slds-button_neutral slds-not-selected circle-button-edit slds-is-absolute" aria-live="assertive">
                <span className="slds-is-relative">
            ...
            <button class="slds-button slds-button_stateful slds-button_neutral slds-not-selected circle-button-add slds-is-absolute" aria-live="assertive">
                <span className="slds-is-relative">
